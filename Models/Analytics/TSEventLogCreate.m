...
@implementation TSEventLogCreate
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"EventTypeRef" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"eventTypeRef"},
		@"Location" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"location"},
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"eventLogCreateID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.eventLogCreateID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/EventLogCreate/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/EventLogCreate";
  
}

+ (instancetype)eventLogCreateWithID: (NSNumber *)objectID {

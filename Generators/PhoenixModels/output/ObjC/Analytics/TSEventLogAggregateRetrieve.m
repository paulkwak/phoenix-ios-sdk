...
@implementation TSEventLogAggregateRetrieve
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"EventTypeReference" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"eventTypeReference"},
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"eventLogAggregateRetrieveID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.eventLogAggregateRetrieveID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/EventLogAggregateRetrieve/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/EventLogAggregateRetrieve";
  
}

+ (instancetype)eventLogAggregateRetrieveWithID: (NSNumber *)objectID {

...
@implementation TSPlatformInstance
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"platformInstanceID"},
		@"Name" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"name"},
		@"ConsoleUrl" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"consoleUrl"},
		@"ApiUrl" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"apiUrl"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.platformInstanceID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/PlatformInstance/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/PlatformInstance";
  
}

+ (instancetype)platformInstanceWithID: (NSNumber *)objectID {

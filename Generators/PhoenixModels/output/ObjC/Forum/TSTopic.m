...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"topicID"},
		@"ForumId" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"forumID"},
		@"TopicTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"topicTypeID"},
		...
		@"Forum" : @{@"type": @"relationship", @"mappedType":@"TSForum", @"mappedName": @"forum"}
	};
}

- (NSString *)dbKey {
	
    return [[self class] dbKeyWithID:self.topicID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Topic/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Topic";
  
}

+ (instancetype)topicWithID: (NSNumber *)objectID {
